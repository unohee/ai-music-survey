...
const I18N = {
  en: {
    ...
    privacy_no_ai: 'No AI models run on this site. We only use pre-recorded AI-generated audio clips for the listening test.',
    usage_title: 'Planned Usage',
    usage_publication: 'Academic publication (ISMIR 2026)',
    usage_validation: 'Model validation for AI music detection',
    usage_perception: 'Understanding human perception vs. algorithmic detection',
    dataset_title: 'Audio Sources',
    dataset_desc: '200 tracks (100 AI + 100 Real), each 12-second segments with variants (8s, 4s, 128kbps, 64kbps).',
    dataset_ai: '<strong>AI-generated</strong>: Suno (v3/v4), Udio, Stable Audio — collected from public YouTube uploads and direct platform outputs.',
    dataset_real_fma: '<strong>Real (FMA)</strong>: <a href="https://github.com/mdeff/fma" target="_blank" rel="noopener">Free Music Archive</a> — ~25K CC-licensed tracks across diverse genres.',
    dataset_real_gtzan: '<strong>Real (GTZAN)</strong>: <a href="http://marsyas.info/downloads/datasets.html" target="_blank" rel="noopener">GTZAN Genre Collection</a> — 1,000 tracks, 10 genres.',
    dataset_real_musdb: '<strong>Real (MUSDB18)</strong>: <a href="https://sigsep.github.io/datasets/musdb.html" target="_blank" rel="noopener">MUSDB18-HQ</a> — professional multitrack recordings (CC-BY-NC).',
    dataset_processing: 'All audio is level-normalized (EBU R128), segmented at track level, and filename-hashed to prevent identification bias.',
  ...
  ko: {
    ...
    privacy_no_ai: '이 사이트에서는 어떠한 AI 모델도 실행되지 않습니다. 사전 녹음된 AI 생성 오디오 클립만 청취 테스트에 사용됩니다.',
    usage_title: '데이터 활용 계획',
    usage_publication: '학술 논문 발표 (ISMIR 2026)',
    usage_validation: 'AI 음악 탐지 모델 검증',
    usage_perception: '사람의 인지 vs. 알고리즘 탐지 비교 연구',
    dataset_title: '오디오 출처',
    dataset_desc: '총 200개 트랙 (AI 100 + Real 100), 각 12초 세그먼트 + 변형본 (8초, 4초, 128kbps, 64kbps).',
    dataset_ai: '<strong>AI 생성</strong>: Suno (v3/v4), Udio, Stable Audio — 공개 YouTube 업로드 및 플랫폼 직접 출력물에서 수집.',
    dataset_real_fma: '<strong>Real (FMA)</strong>: <a href="https://github.com/mdeff/fma" target="_blank" rel="noopener">Free Music Archive</a> — 다양한 장르의 CC 라이선스 트랙 ~25,000곡.',
    dataset_real_gtzan: '<strong>Real (GTZAN)</strong>: <a href="http://marsyas.info/downloads/datasets.html" target="_blank" rel="noopener">GTZAN Genre Collection</a> — 10개 장르, 1,000곡.',
    dataset_real_musdb: '<strong>Real (MUSDB18)</strong>: <a href="https://sigsep.github.io/datasets/musdb.html" target="_blank" rel="noopener">MUSDB18-HQ</a> — 전문 멀티트랙 녹음 (CC-BY-NC).',
    dataset_processing: '모든 오디오는 EBU R128 레벨 정규화, 트랙 단위 세그먼팅, 파일명 해싱 처리되어 식별 편향을 방지합니다.',
